...
arg2 : number of cores to use
arg3 : min account age (i.e. acct must be created before this date). Format is month-year (6-2013)
arg4 : tweets must be sent after this period (same format as above)
arg5->inf : of format keyword=n_replies_to_get,n_non_replies_to_get
"""

#python get_random_tweets.py /usr3/kjoseph/ferguson/data/user_collection/json/ 40 1-2013 8-2014
# random=250,500 police=50,100 brat=2,3 husband=2,3 bully=2,3 businessman=2,3 father=2,3 guest=2,3
# redhead=2,3 girlfriend=2,3 lesbian=2,3 moron=2,3 friend=2,3 roommate=2,3 neighbor=2,3 neurotic=2,3
# psychopath=2,3 liar=2,3 slut=2,3 jew=2,3 gunman=2,3 victim=2,3
...
for dataset_descrip in sys.argv[5:]:
    ...
    text = '' if spl[0] == 'random' else spl[0].replace("_"," ")
